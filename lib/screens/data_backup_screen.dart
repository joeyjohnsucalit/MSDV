    ...
    return SizedBox(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          hintText: 'Search...',
          hintStyle:
              const TextStyle(fontSize: 12, color: Color(0xFFb0bac7)),
          prefixIcon:
              const Icon(Icons.search, size: 14, color: Color(0xFFb0bac7)),
          filled: true,
...
class _TallyDots extends StatelessWidget {
  ...
  final bool isMajor;
  const _TallyDots(
      {required this.filled, required this.max, required this.isMajor});
  ...
  Widget build(BuildContext context) {
    ...
    final emptyBorder =
        isMajor ? const Color(0xFFfecaca) : const Color(0xFFfde68a);
        ...
        ...List.generate(max, (i) {
          ...
          return Container(
            ...
            decoration: BoxDecoration(
              ...
              border: isFilled ? null : Border.all(color: emptyBorder),
            ),
          );
        }),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: const Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(Icons.draw_outlined, size: 11, color: Color(0xFF16a34a)),
          SizedBox(width: 4),
          Text('Signed',
              style: TextStyle(
                  fontSize: 10,
